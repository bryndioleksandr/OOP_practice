...
public:
    ...
    void retranslateUi(QDialog *CreateDoc)
    {
        ...
        label->setText(QCoreApplication::translate("CreateDoc", "Input all the data about Doctor", nullptr));
        ...
        confirmDocPb->setText(QCoreApplication::translate("CreateDoc", "Confirm and create", nullptr));
    } // retranslateUi
