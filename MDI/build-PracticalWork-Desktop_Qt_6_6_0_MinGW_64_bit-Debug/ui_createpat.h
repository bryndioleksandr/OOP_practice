...
public:
    ...
    void retranslateUi(QDialog *CreatePat)
    {
        ...
        label->setText(QCoreApplication::translate("CreatePat", "Input all the data about Patient", nullptr));
        ...
        confirmPatPb->setText(QCoreApplication::translate("CreatePat", "Confirm and create", nullptr));
    } // retranslateUi
